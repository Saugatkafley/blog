function SkillItem({ name }: { name: string }) {
  return (
    <div className="m-1 flex items-center">
      <svg
        className="m-1 h-6 w-6 rounded-full bg-green-200 p-1 dark:bg-green-200"
      ...
      <div className="px-1 text-center font-light transition-all delay-100 hover:text-purple-400 hover:transition-colors">
        {name}
      </div>
    </div>
  )
